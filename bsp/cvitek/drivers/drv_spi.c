...
#ifdef BSP_USING_SPI0
// spi0 is not ALLOWED for Duo
static const char *pinname_whitelist_spi0_scl[] = {
    NULL,
};
...
#ifdef BSP_USING_SPI1
// spi1 is not ALLOWED for Duo
static const char *pinname_whitelist_spi1_scl[] = {
    NULL,
};
...
#ifdef BSP_USING_SPI3
// spi3 is not ALLOWED for Duo
static const char *pinname_whitelist_spi3_scl[] = {
    NULL,
};
...
#ifdef BSP_USING_SPI0
// spi0 is not ALLOWED for Duo256M
static const char *pinname_whitelist_spi0_scl[] = {
    NULL,
};
static const char *pinname_whitelist_spi0_sdi[] = {
...
#ifdef BSP_USING_SPI1
// spi1 is not ALLOWED for Duo256M
...
#ifdef BSP_USING_SPI3
// spi3 is not ALLOWED for Duo256M
